...
def get_arguments(descmsg: str = DESCMSG) -> argparse.Namespace:
    ...
    opt.add_argument("-ht", "--highlight_thresh", default=5e-8, type=float, metavar="float",
                     help="P-value threshold for highlighting (default: 5e-8).")
    opt.add_argument("-hl_line", "--highlight_line", action="store_true",
    ...
    # circular only
    cio.add_argument("--pad", default=1, type=int, metavar="int",
                     help="Space between circular tracks (default: 1).")
    cio.add_argument("-cl_size", "--chrom_label_size",  default=6, type=float, metavar="float",
                     help="Chromosome label font size (default: 6).")
    cio.add_argument("-cl_side", "--chrom_label_side", choices=["inside", "outside"],
                     nargs="?", default="inside", const="inside", type=str,
                     help="Chromosome label placement (default: inside).")
    cio.add_argument("-tl_size", "--track_label_size", default=6, type=float, metavar="float",
                     help="Track label font size (default: 6).")
    cio.add_argument("-tl_orient", "--track_label_orientation",
                     choices=["vertical", "horizontal"], nargs="?",
                     default="vertical", const="vertical", type=str,
                     help="Track label orientation (default: vertical).")
    cio.add_argument("--r_min", default=20, type=int, metavar="int",
                     help="Inner radius proportion (circular mode, default: 20).")
    cio.add_argument("--r_max", default=100, type=int, metavar="int",
                     help="Outer radius (circular mode, default: 100).")

    # linear only
    lio.add_argument("-th", "--track_heights", type=str, metavar="str",
    ...
    lio.add_argument("-t_space", "--track_spacing", default=0.10, type=float, metavar="float",
